...
export function assembleItinerary({ tripId, sentence, brief, timezone, discovery, composed, contextResult, calendarResult, notionResult, themeName, posterResult, agentStatuses }) {
